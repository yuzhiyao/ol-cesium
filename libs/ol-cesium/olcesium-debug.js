...
class AbstractSynchronizer {
  ...
  addLayers_(root) {
    ...
    while (fifo.length > 0) {
      ...
      const olLayerId = Object(_util_js__WEBPACK_IMPORTED_MODULE_2__["getUid"])(olLayer).toString();
      ...
      if (olLayer instanceof ol_layer_Group_js__WEBPACK_IMPORTED_MODULE_1___default.a) {
        ...
        if (!cesiumObjects) {
          ...
          this.olLayerListenKeys[olLayerId].push(Object(_util_js__WEBPACK_IMPORTED_MODULE_2__["olcsListen"])(layerWithParents.layer, 'change', onLayerChange));
        }
      }
      // add Cesium layers
      if (cesiumObjects) {
  ...
  addCesiumObjects_(cesiumObjects, layerId, layer) {
    ...
    this.olLayerListenKeys[layerId].push(Object(_util_js__WEBPACK_IMPORTED_MODULE_2__["olcsListen"])(layer, 'change:zIndex', () => this.orderLayers()));
  ...
  removeAndDestroySingleLayer_(layer) {
    const uid = Object(_util_js__WEBPACK_IMPORTED_MODULE_2__["getUid"])(layer).toString();
  ...
  unlistenSingleGroup_(group) {
    ...
    const uid = Object(_util_js__WEBPACK_IMPORTED_MODULE_2__["getUid"])(group).toString();
  ...
  listenForGroupChanges_(group) {
    const uuid = Object(_util_js__WEBPACK_IMPORTED_MODULE_2__["getUid"])(group).toString();
...
class Camera {
  ...
  setView_(view) {
    ...
    this.view_ = view;
    if (view) {
      const toLonLat = Object(ol_proj_js__WEBPACK_IMPORTED_MODULE_2__["getTransform"])(view.getProjection(), 'EPSG:4326');
      const fromLonLat = Object(ol_proj_js__WEBPACK_IMPORTED_MODULE_2__["getTransform"])('EPSG:4326', view.getProjection());
  ...
  setPosition(position) {
    ...
    const carto = new Cesium.Cartographic(
        Object(_math_js__WEBPACK_IMPORTED_MODULE_1__["toRadians"])(ll[0]),
        Object(_math_js__WEBPACK_IMPORTED_MODULE_1__["toRadians"])(ll[1]),
        this.getAltitude());
  ...
  getPosition() {
    ...
    const pos = this.fromLonLat_([
      Object(_math_js__WEBPACK_IMPORTED_MODULE_1__["toDegrees"])(carto.longitude),
      Object(_math_js__WEBPACK_IMPORTED_MODULE_1__["toDegrees"])(carto.latitude)
    ]);
    console.assert(pos);
    return pos;
  }
  ...
  updateCamera_() {
    ...
    const carto = new Cesium.Cartographic(Object(_math_js__WEBPACK_IMPORTED_MODULE_1__["toRadians"])(ll[0]),
        Object(_math_js__WEBPACK_IMPORTED_MODULE_1__["toRadians"])(ll[1]));
  ...
  readFromView() {
    ...
    this.distance_ = this.calcDistanceForResolution(
        resolution || 0, Object(_math_js__WEBPACK_IMPORTED_MODULE_1__["toRadians"])(ll[1]));
  ...
  updateView() {
    ...
    this.view_.setCenter(this.fromLonLat_([
      Object(_math_js__WEBPACK_IMPORTED_MODULE_1__["toDegrees"])(bestTargetCartographic.longitude),
      Object(_math_js__WEBPACK_IMPORTED_MODULE_1__["toDegrees"])(bestTargetCartographic.latitude)]));
...
class FeatureConverter {
  ...
  onRemoveOrClearFeature_(evt) {
    ...
    if (cancellers) {
      ...
      if (feature) {
        // remove
        const id = Object(_util_js__WEBPACK_IMPORTED_MODULE_9__["getUid"])(feature);
  ...
  olCircleGeometryToCesium(layer, feature, olGeometry, projection, olStyle) {
    ...
    if (this.getHeightReference(layer, feature, olGeometry) === Cesium.HeightReference.CLAMP_TO_GROUND) {
      const width = this.extractLineWidthFromOlStyle(olStyle);
      if (width) {
        const circlePolygon = Object(ol_geom_Polygon_js__WEBPACK_IMPORTED_MODULE_4__["circular"])(olGeometry.getCenter(), radius);
  ...
  olPolygonGeometryToCesium(layer, feature, olGeometry, projection, olStyle) {
    ...
    if ((olGeometry.getCoordinates()[0].length == 5) &&
      ...
      const extent = Object(ol_extent_js__WEBPACK_IMPORTED_MODULE_5__["boundingExtent"])(coordinates);
  ...
  createBillboardFromImage(
    ...
    if (image instanceof Image && !isImageLoaded(image)) {
      ...
      const fuid = Object(_util_js__WEBPACK_IMPORTED_MODULE_9__["getUid"])(feature);
      if (cancellers[fuid]) {
  ...
  olGeometry4326TextPartToCesium(layer, feature, geometry, style) {
    ...
    const extentCenter = Object(ol_extent_js__WEBPACK_IMPORTED_MODULE_5__["getCenter"])(geometry.getExtent());
  ...
  olFeatureToCesium(layer, feature, style, context, opt_geom) {
    ...
    const newBillboardAddedCallback = function(bb) {
      const featureBb = context.featureToCesiumMap[Object(_util_js__WEBPACK_IMPORTED_MODULE_9__["getUid"])(feature)];
...
class OverlaySynchronizer {
  ...
  */
  addOverlay(overlay) {
    ...
    const overlayId = Object(_util_js__WEBPACK_IMPORTED_MODULE_1__["getUid"])(overlay).toString();
...
class RasterSynchronizer extends _AbstractSynchronizer_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  ...
  createSingleLayerCounterparts(olLayerWithParents) {
    const olLayer = olLayerWithParents.layer;
    const uid = Object(_util_js__WEBPACK_IMPORTED_MODULE_1__["getUid"])(olLayer).toString();
    ...
    if (cesiumObjects) {
      ...
      listenKeyArray.push(olLayer.on('change:extent', (e) => {
        ...
        delete this.layerMap[Object(_util_js__WEBPACK_IMPORTED_MODULE_1__["getUid"])(olLayer)]; // invalidate the map entry
        this.synchronize();
      }));
  ...
  orderLayers() {
    ...
    Object(_util_js__WEBPACK_IMPORTED_MODULE_1__["stableSort"])(layers, (layer1, layer2) =>
      zIndices[Object(_util_js__WEBPACK_IMPORTED_MODULE_1__["getUid"])(layer1)] - zIndices[Object(_util_js__WEBPACK_IMPORTED_MODULE_1__["getUid"])(layer2)]
    );

    layers.forEach((olLayer) => {
      const olLayerId = Object(_util_js__WEBPACK_IMPORTED_MODULE_1__["getUid"])(olLayer).toString();
...
class SynchronizedOverlay extends ol_Overlay_js__WEBPACK_IMPORTED_MODULE_0___default.a {
  /**
...
class VectorSynchronizer extends _AbstractSynchronizer_js__WEBPACK_IMPORTED_MODULE_7__["default"] {
  ...
  createSingleLayerCounterparts(olLayerWithParents) {
    ...
    [olLayerWithParents.layer].concat(olLayerWithParents.parents).forEach((olLayerItem) => {
      olListenKeys.push(Object(_util_js__WEBPACK_IMPORTED_MODULE_4__["olcsListen"])(olLayerItem, 'change:visible', () => {
    ...
    const onAddFeature = (function(feature) {
      console.assert(
          (olLayer instanceof ol_layer_Vector_js__WEBPACK_IMPORTED_MODULE_5___default.a) ||
          (olLayer instanceof ol_layer_Image_js__WEBPACK_IMPORTED_MODULE_3___default.a)
      );
      const context = counterpart.context;
    ...
    const onRemoveFeature = (function(feature) {
      const id = Object(_util_js__WEBPACK_IMPORTED_MODULE_4__["getUid"])(feature);
      const context = counterpart.context;
    ...
    olListenKeys.push(Object(_util_js__WEBPACK_IMPORTED_MODULE_4__["olcsListen"])(source, 'addfeature', (e) => {
      console.assert(e.feature);
      onAddFeature(e.feature);
    }, this));

    olListenKeys.push(Object(_util_js__WEBPACK_IMPORTED_MODULE_4__["olcsListen"])(source, 'removefeature', (e) => {
      console.assert(e.feature);
      onRemoveFeature(e.feature);
    }, this));

    olListenKeys.push(Object(_util_js__WEBPACK_IMPORTED_MODULE_4__["olcsListen"])(source, 'changefeature', (e) => {
...
const Manager = class extends ol_Observable_js__WEBPACK_IMPORTED_MODULE_4___default.a {
  /**
  ...
  constructor(cesiumUrl, {map, cameraExtentInRadians} = {}) {
     ...
     * @private
     */
    this.cesiumInitialTilt_ = Object(_math_js__WEBPACK_IMPORTED_MODULE_3__["toRadians"])(50);
...
exports.extentToRectangle = function(extent, projection) {
  if (extent && projection) {
    const ext = Object(ol_proj_js__WEBPACK_IMPORTED_MODULE_3__["transformExtent"])(extent, projection, 'EPSG:4326');
...
exports.tileLayerToImageryLayer = function(olMap, olLayer, viewProj) {
  ...
  if (source instanceof ol_source_ImageWMS_js__WEBPACK_IMPORTED_MODULE_5___default.a && source.getUrl() &&
    source.getImageLoadFunction() === ol_source_Image_js__WEBPACK_IMPORTED_MODULE_8__["defaultImageLoadFunction"]) {
    const sourceProps = {
  ...
  if (source instanceof ol_source_TileImage_js__WEBPACK_IMPORTED_MODULE_6___default.a) {
    let projection = _util_js__WEBPACK_IMPORTED_MODULE_10__["default"].getSourceProjection(source);
...
exports.olGeometryCloneTo4326 = function(geometry, projection) {
  ...
  const proj4326 = Object(ol_proj_js__WEBPACK_IMPORTED_MODULE_3__["get"])('EPSG:4326');
  const proj = Object(ol_proj_js__WEBPACK_IMPORTED_MODULE_3__["get"])(projection);
  if (proj !== proj4326) {
...
exports.isCesiumProjection = function(projection) {
  const is3857 = projection === Object(ol_proj_js__WEBPACK_IMPORTED_MODULE_3__["get"])('EPSG:3857');
  const is4326 = projection === Object(ol_proj_js__WEBPACK_IMPORTED_MODULE_3__["get"])('EPSG:4326');
